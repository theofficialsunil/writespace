                    ...
                    <div className="space-y-8">
                        <div className="space-y-4">
                            ...
                            <p className="max-w-lg text-xl text-muted-foreground">
                                WriteSpace is a modern publishing platform for
                                writers, readers, educators, and creators.
                            </p>
                        </div>
                    ...
                    <div className="rounded-2xl bg-gradient-to-br from-primary/20 to-muted p-8">
                        <div className="rounded-xl bg-background p-8 shadow-sm">
                            ...
                            <h2 className="mt-2 text-3xl font-bold">
                                Publish clean articles with rich editing,
                                comments, likes, and analytics.
                            </h2>
                        </div>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="mx-auto mb-12 max-w-2xl text-center">
                        ...
                        <p className="mt-4 text-lg text-muted-foreground">
                            Create, draft, publish, and track articles from one
                            dashboard.
                        </p>
                    </div>
                    ...
                    <div className="grid gap-8 md:grid-cols-3">
                        ...
                        <Card className="text-center">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Readers can like, comment, and bookmark
                                    posts.
                                </CardDescription>
                            </CardHeader>
                        </Card>
                        ...
                        <Card className="text-center">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Track views, likes, comments, and post
                                    performance.
                                </CardDescription>
                            </CardHeader>
                        </Card>
